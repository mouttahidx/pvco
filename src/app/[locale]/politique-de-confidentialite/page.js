    ...
    <>
      ...
      >
        <div className="no-tailwindcss-base">
          ...
          vous informer sur nos politiques concernant la collecte, l'utilisation
          et la divulgation des renseignements personnels fournis par les
          utilisateurs du site. Cette politique de confidentialité s'applique à
          la totalité du site ainsi qu'à tous les produits et services que nous
          proposons. L’objectif de cette politique de confidentialité est
          d’informer les utilisateurs de notre site des informations
          personnelles que nous pouvons recueillir, ainsi que sur la façon dont
          ces dernières sont utilisées et gérées.
          ...
          politique, veuillez s’il vous plaît ne pas utiliser notre site. En
          maintenant votre utilisation du site à la suite de l'affichage des
          changements à cette politique, vous serez considéré comme ayant
          ...
          l'heure et la date de votre visite, la durée passée sur ces pages et
          ...
          ainsi que d'autres informations susceptibles de vous intéresser. Vous
          avez la possibilité de refuser de recevoir l’ensemble de ces
          ...
          considérons qu'une telle action est nécessaire pour nous conformer à
          la loi et répondre aux demandes légitimes des autorités chargées de
          l'application de la loi, ou encore pour préserver la sécurité et
          l'intégrité de notre site.
          ...
          autorisées disposant de droits d'accès spéciaux à ces systèmes sont en
          mesure d'y accéder et sont tenues de maintenir la confidentialité des
          informations. Nous ne conservons pas vos informations personnelles,
          telles que les cartes de crédit, les informations financières, etc.,
          sur nos serveurs une fois la transaction terminée. Nous accordons une
          grande importance à la sécurité de vos renseignements personnels. Cela
          dit, il est important de noter qu'aucune méthode de transmission sur
          Internet ni de stockage électronique n’est jamais entièrement
          sécurisée à 100 % . Nous mettons en place des mesures de sécurité
          appropriées et acceptées sur le plan commercial pour protéger vos
          renseignements personnels. Cependant, nous ne pouvons pas garantir une
          sécurité absolue.
          <h3>Liens vers d'autres sites</h3>
          Il est possible que notre site contienne des liens vers d'autres sites
          qui ne sont pas sous notre contrôle. Si vous décidez de cliquer sur un
          de ces liens, vous serez redirigé vers le site d'un tiers. Nous vous
          recommandons fortement de lire la politique de confidentialité de
          chaque site que vous visitez. PVCO Granby ne peut garantir ni
          contrôler le contenu, les politiques de confidentialité ou les
          pratiques des sites ou services tiers et n’est donc pas responsable de
          ces aspects pour les sites ou services tiers.
          ...
          intentionnellement d'informations personnelles auprès d'enfants de
          moins de 14 ans. Veuillez nous contacter si vous êtes parent ou tuteur
          et que vous découvrez que vos enfants nous ont fourni des informations
          personnelles. À la suite de leur découverte, les informations
          personnelles fournies par une personne âgée de moins de 14 ans seront
          immédiatement supprimées de nos serveurs.
          <h2>Vos droits en tant qu’utilisateur</h2>
          Vous avez le droit d’accéder aux informations personnelles que nous
          avons collectées sur vous en tout temps. Vous avez le droit de mettre
          à jour ou de corriger toute information personnelle que nous possédons
          et qui vous concerne, dans la mesure où cela est autorisé par la loi.
          Vous pouvez révoquer ou modifier votre consentement à la collecte de
          vos données à tout moment, dans la mesure où cela est considéré comme
          acceptable et à condition de nous en aviser dans un délai raisonnable.
          ...
          confidentialité afin de prendre connaissance d'éventuels changements.
          ...
          l'utilisation de témoins pour recueillir des informations. Il vous est
          possible de configurer votre navigateur afin de refuser tous les
          témoins ou d'être averti lorsque ceux-ci sont envoyés. Cependant,
          veuillez noter que si vous choisissez de ne pas accepter les témoins,
          certaines parties de notre site pourraient ne pas être accessibles.
          Pour en savoir plus sur la gestion des témoins, veuillez consulter
          notre Politique de témoins.
          <h3>Ne pas suivre</h3>
          La fonctionnalité "Ne pas suivre" (ou DNT) est une préférence que vous
          pouvez activer sur votre navigateur. En activant “Ne pas suivre”, vous
          indiquez aux sites que vous visitez que vous ne souhaitez pas que
          certaines informations vous concernant soient collectées. PVCO Granby
          utilise Remarketing avec Google Analytics pour diffuser des publicités
          sur des sites tiers après votre visite sur notre site. Nous et nos
          fournisseurs tiers, tel que Google, utilisons des témoins internes
          (comme les témoins Google Analytics) et des témoins tiers (comme les
          témoins DoubleClick). Nous utilisons des témoins dans le but
          d’informer, d'optimiser et de diffuser des annonces selon vos visites
          précédentes sur notre site. Vous pouvez choisir de ne pas utiliser
          Google Analytics pour l’affichage publicitaire et personnaliser les
          annonces sur le réseau Display de Google en vous rendant sur la page
          Paramètres Google Ads. Pour les visiteurs désirant prévenir la
          collecte et l’utilisation de leurs données par Google Analytics,
          Google suggère également d'installer l'extension complémentaire Google
          Analytics Opt-out Browser Add-on sur leur navigateur.
          <h2>Termes et conditions</h2>
          Nous vous encourageons également à consulter notre section Termes et
          Conditions, où vous trouverez des informations sur l'utilisation du
          site, les avertissements et les limitations de responsabilité qui
          s'appliquent.
