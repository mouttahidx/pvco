...
export async function generateMetadata() {
  const t = await getTranslations("RailingModelTraditionalGlass");
...
export default function RailingModelTraditionalGlass() {
  const locale = useLocale();
  const t = useTranslations("RailingModelTraditionalGlass");
  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          backgroundImage:
            "url('/img/railing/aluminiumrailing/sunspace-traditional-glass-railing-banner-1.jpg')",
        }}
      >
      ...
      <section className="max-w-7xl mx-auto pt-32 pb-16 grid grid-cols-1 lg:grid-cols-3 gap-x-8">
        ...
        <div className="lg:col-span-2 px-2">
          <Image
            alt={t("title")}
            src={
              "/img/railing/aluminiumrailing/sunspace-traditional-glass-railing-banner-2.jpg"
            }
            width={1200}
            height={720}
        ...
        <div className="w-full lg:col-span-3 mt-14 px-2">
          ...
          <div className="mt-8">
            <GalleryProductPage
              slides={[
                {
                  src: "/img/railing/aluminiumrailing/railing-traditional-glass (1).webp",
                },
                {
                ...
                {
                  src: "/img/railing/aluminiumrailing/railing-traditional-glass (9).webp",
                },
                {
                ...
                {
                  src: "/img/railing/aluminiumrailing/railing-traditional-glass (13).webp",
                },
                {
                ...
                {
                  src: "/img/railing/aluminiumrailing/railing-traditional-glass (24).webp",
                },
                {
