...
export async function generateMetadata() {
  const t = await getTranslations("RailingModelIntegrated");
...
export default function RailingModelIntegrated() {
  const t = useTranslations("RailingModelIntegrated");
  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          backgroundImage:
            "url('/img/railing/integratedrailing/sunspace-integrated-railing-screen-banner-1.jpg')",
        }}
      >
      ...
      <section className="max-w-7xl mx-auto pt-32 pb-16 grid grid-cols-1 lg:grid-cols-3 gap-x-8">
        ...
        <div className="lg:col-span-2 px-2">
          <Image
            alt={t("title")}
            src={
              "/img/railing/integratedrailing/sunspace-integrated-railing-screen-banner-1.jpg"
            }
            width={1200}
            height={720}
        ...
        <div className="w-full lg:col-span-3 mt-14 px-2">
          ...
          <div className="mt-8">
            <GalleryProductPage
              slides={[
                {
                  src: "/img/railing/integratedrailing/railing-integrated (1).webp",
                },
                {
                  src: "/img/railing/integratedrailing/railing-integrated (2).webp",
                },
                {
                  src: "/img/railing/integratedrailing/railing-integrated (3).webp",
                },
                {
                  src: "/img/railing/integratedrailing/railing-integrated (4).webp",
                },
                {
                  src: "/img/railing/integratedrailing/railing-integrated (5).webp",
                },
                {
                  src: "/img/railing/integratedrailing/railing-integrated (6).webp",
                },
              ]}
              large={[
                {
