...
export async function generateMetadata() {
  const t = await getTranslations("SunroomsModel300");
...
export default function SunroomsModel300() {
  const t = useTranslations("SunroomsModel300");
  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          backgroundImage:
            "url('/img/sunrooms/model300/sunspace-sunroom-model-300-banner-1.jpg')",
        }}
      >
      ...
      <section className="max-w-7xl mx-auto pt-32 pb-16 grid grid-cols-1 lg:grid-cols-3 gap-x-8">
        ...
        <div className="lg:col-span-2 px-2 ">
          <Image
            alt={t("title")}
            src={
              "/img/sunrooms/model300/sunspace-sunroom-model-300-banner-2.jpg"
            }
            width={1200}
            height={720}
          ...
          <div className="mt-8">
            ...
            <div className="grid md:grid-cols-2 mt-8 gap-4 ">
              ...
              <div>
                <iframe
                  className="w-full h-[350px] lg:h-[250px]"
                  src="https://www.youtube.com/embed/qf746zQdSyw"
                  title="Inspiration Sunspace -2"
                  frameBorder="0"
                  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                  referrerPolicy="strict-origin-when-cross-origin"
                  allowFullScreen
        ...
        <div className="w-full lg:col-span-3 mt-14 px-2">
          ...
          <div className="mt-8">
            <GalleryProductPage
              slides={[
                { src: "/img/sunrooms/model300/sunrooms-model300 (1).webp" },
                { src: "/img/sunrooms/model300/sunrooms-model300 (2).webp" },
                { src: "/img/sunrooms/model300/sunrooms-model300 (3).webp" },
                { src: "/img/sunrooms/model300/sunrooms-model300 (4).webp" },
                { src: "/img/sunrooms/model300/sunrooms-model300 (5).webp" },
                { src: "/img/sunrooms/model300/sunrooms-model300 (6).webp" },
                { src: "/img/sunrooms/model300/sunrooms-model300 (7).webp" },
                { src: "/img/sunrooms/model300/sunrooms-model300 (8).webp" },
                { src: "/img/sunrooms/model300/sunrooms-model300 (9).webp" },
                { src: "/img/sunrooms/model300/sunrooms-model300 (10).webp" },
                { src: "/img/sunrooms/model300/sunrooms-model300 (11).webp" },
                { src: "/img/sunrooms/model300/sunrooms-model300 (12).webp" },
                { src: "/img/sunrooms/model300/sunrooms-model300 (13).webp" },
                { src: "/img/sunrooms/model300/sunrooms-model300 (14).webp" },
              ]}
              large={[
                { src: "/img/sunrooms/model300/sunrooms-model300 (1).webp" },
                { src: "/img/sunrooms/model300/sunrooms-model300 (2).webp" },
