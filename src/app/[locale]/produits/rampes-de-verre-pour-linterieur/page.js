...
export async function generateMetadata() {
  const t = await getTranslations("InteriorGlassPage");
...
export default function InteriorGlassPage() {
  const t = useTranslations("InteriorGlassPage");
  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          backgroundImage:
            "url('/img/interior-glass/sunspace-interior-glass-railings-banner-1.jpg')",
        }}
      >
      ...
      <section className="max-w-7xl mx-auto pt-32 pb-16 grid grid-cols-1 lg:grid-cols-3 gap-x-8">
        ...
        <div className="lg:col-span-2 px-2">
          <Image
            alt={t("title")}
            src={
              "/img/interior-glass/sunspace-interior-glass-railings-banner-2.jpg"
            }
            width={1200}
            height={720}
            ...
            <div className="grid md:grid-cols-2 mt-8 gap-4 ">
              <div>
                <iframe
                  ...
                  src="https://www.youtube.com/embed/Xjx96ElDL3Y"
                  title="Sunspace Interior Glass Railings"
                  frameBorder="0"
              ...
              <div>
                <iframe
                  className="w-full h-[350px] lg:h-[250px]"
                  src="https://www.youtube.com/embed/WVYhopvefRI"
                  title="Sunspace Aluminum Railings, Sunrail systems"
                  frameBorder="0"
                  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                  referrerPolicy="strict-origin-when-cross-origin"
                  allowFullScreen
        ...
        <div className="w-full lg:col-span-3 mt-14 px-2">
          ...
          <div className="mt-8">
            <GalleryProductPage
              slides={[
                {src: "/img/interior-glass/sunspace-interior-glass-railings_0001.jpg"},
                {src: "/img/interior-glass/sunspace-interior-glass-railings_0002.jpg"},
                {src: "/img/interior-glass/sunspace-interior-glass-railings_0003.jpg"},
                {src: "/img/interior-glass/sunspace-interior-glass-railings_0004.jpg"},
                {src: "/img/interior-glass/sunspace-interior-glass-railings_0005.jpg"},
                {src: "/img/interior-glass/sunspace-interior-glass-railings_0006.jpg"},
                {src: "/img/interior-glass/sunspace-interior-glass-railings_0007.jpg"},
                {src: "/img/interior-glass/sunspace-interior-glass-railings_0008.jpg"},
                {src: "/img/interior-glass/sunspace-interior-glass-railings_0009.jpg"},
                {src: "/img/interior-glass/sunspace-interior-glass-railings_0010.jpg"},
              ]}

              large={[
                {src: "/img/interior-glass/large/sunspace-interior-glass-railings_0001.jpg"},
                {src: "/img/interior-glass/large/sunspace-interior-glass-railings_0002.jpg"},
                {src: "/img/interior-glass/large/sunspace-interior-glass-railings_0003.jpg"},
                {src: "/img/interior-glass/large/sunspace-interior-glass-railings_0004.jpg"},
                {src: "/img/interior-glass/large/sunspace-interior-glass-railings_0005.jpg"},
                {src: "/img/interior-glass/large/sunspace-interior-glass-railings_0006.jpg"},
                {src: "/img/interior-glass/large/sunspace-interior-glass-railings_0007.jpg"},
                {src: "/img/interior-glass/large/sunspace-interior-glass-railings_0008.jpg"},
                {src: "/img/interior-glass/large/sunspace-interior-glass-railings_0009.jpg"},
                {src: "/img/interior-glass/large/sunspace-interior-glass-railings_0010.jpg"},
              ]}
              title={t('title')}
