...
export async function generateMetadata() {
  const t = await getTranslations("WeatherMasterHorizontal");
...
export default function WeatherMasterHorizontal() {
  const t = useTranslations("WeatherMasterHorizontal");
  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          backgroundImage:
            "url('/img/weathermaster/weathermasterhorizontal/sunspace-weathermaster-horizontal-four-track-banner-1.jpg')",
        }}
      >
      ...
      <section className="max-w-7xl mx-auto pt-32 pb-16 grid grid-cols-1 lg:grid-cols-3 gap-x-8">
        ...
        <div className="lg:col-span-2 px-2">
          <Image
            alt={t("title")}
            src={
              "/img/weathermaster/weathermasterhorizontal/sunspace-weathermaster-horizontal-four-track-banner-2.jpg"
            }
            width={1200}
            height={720}
        ...
        <div className="px-2 lg:px-0 gap-y-8 flex flex-col mt-8 lg:mt-0">
          ...
          <div className="p-8 bg-light-gray rounded-3xl">
            ...
            <a
              href={
                locale === "en"
                  ? "/pdf/Sunspace-Horizontal-Window-System.pdf"
                  : "/pdf/Sunspace-Horizontal-Window-System-fr.pdf"
              }
              target="_blank"
            >
        ...
        <div className="w-full lg:col-span-3 mt-14 px-2">
          ...
          <div className="mt-8">
            <GalleryProductPage
              slides={[
                {
                  src: "/img/weathermaster/weathermasterhorizontal/weathermaster-horizontal (1).webp",
                },
                {
                  src: "/img/weathermaster/weathermasterhorizontal/weathermaster-horizontal (2).webp",
                },
                {
                  src: "/img/weathermaster/weathermasterhorizontal/weathermaster-horizontal (3).webp",
                },
                {
                  src: "/img/weathermaster/weathermasterhorizontal/weathermaster-horizontal (4).webp",
                },
                {
                  src: "/img/weathermaster/weathermasterhorizontal/weathermaster-horizontal (5).webp",
                },
                {
                  src: "/img/weathermaster/weathermasterhorizontal/weathermaster-horizontal (6).webp",
                },
                {
                  src: "/img/weathermaster/weathermasterhorizontal/weathermaster-horizontal (7).webp",
                },
                {
                  src: "/img/weathermaster/weathermasterhorizontal/weathermaster-horizontal (8).webp",
                },
                {
                  src: "/img/weathermaster/weathermasterhorizontal/weathermaster-horizontal (9).webp",
                },
                {
                  src: "/img/weathermaster/weathermasterhorizontal/weathermaster-horizontal (10).webp",
                },
                {
                  src: "/img/weathermaster/weathermasterhorizontal/weathermaster-horizontal (11).webp",
                },
                {
                  src: "/img/weathermaster/weathermasterhorizontal/weathermaster-horizontal (12).webp",
                },
                {
                  src: "/img/weathermaster/weathermasterhorizontal/weathermaster-horizontal (13).webp",
                },
                {
                  src: "/img/weathermaster/weathermasterhorizontal/weathermaster-horizontal (14).webp",
                },
                {
                  src: "/img/weathermaster/weathermasterhorizontal/weathermaster-horizontal (15).webp",
                },
                {
                  src: "/img/weathermaster/weathermasterhorizontal/weathermaster-horizontal (16).webp",
                },
                {
                  src: "/img/weathermaster/weathermasterhorizontal/weathermaster-horizontal (17).webp",
                },
                {
                  src: "/img/weathermaster/weathermasterhorizontal/weathermaster-horizontal (18).webp",
                },
                {
                  src: "/img/weathermaster/weathermasterhorizontal/weathermaster-horizontal (19).webp",
                },
                {
                  src: "/img/weathermaster/weathermasterhorizontal/weathermaster-horizontal (20).webp",
                },
              ]}
              large={[
                {
