...
export async function generateMetadata() {
  const t = await getTranslations("WeatherMasterWindows");
...
export default function WeatherMasterWindows() {
  const t = useTranslations("WeatherMasterWindows");
  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          backgroundImage:
            "url('/img/weathermaster/weathermasterwindows/sunspace-weathermaster-windows-banner-1.jpg')",
        }}
      >
      ...
      <section className="max-w-7xl mx-auto pt-32 pb-16 grid grid-cols-1 lg:grid-cols-3 gap-x-8">
        ...
        <div className="lg:col-span-2 px-2">
          <Image
            alt={t("title")}
            src={
              "/img/weathermaster/weathermasterwindows/sunspace-weathermaster-windows-banner-2.jpg"
            }
            width={1200}
            height={720}
            ...
            <div className="grid md:grid-cols-2 mt-8 gap-4 ">
              <div>
                <iframe
                  ...
                  src="https://www.youtube.com/embed/hkjKPySPCwc"
                  title="Sunspace Sunrooms weathermaster vertical 4 track windows with aluminum and glass railings"
                  frameBorder="0"
        ...
        <div className="px-2 lg:px-0 gap-y-8 flex flex-col mt-8 lg:mt-0">
          ...
          <div className="p-8 bg-light-gray rounded-3xl">
            ...
            <a
              href={
                locale === "en"
                  ? "/pdf/Sunspace-Vertical-Window-System.pdf"
                  : "/pdf/Sunspace-Vertical-Window-System-fr.pdf"
              }
              target="_blank"
            >
        ...
        <div className="w-full lg:col-span-3 mt-14 px-2">
          ...
          <div className="mt-8">
            <GalleryProductPage
              slides={[
                {
                  src: "/img/weathermaster/weathermasterwindows/weathermaster-vertical (1).webp",
                },
                {
                  src: "/img/weathermaster/weathermasterwindows/weathermaster-vertical (2).webp",
                },
                {
                  src: "/img/weathermaster/weathermasterwindows/weathermaster-vertical (3).webp",
                },
                {
                  src: "/img/weathermaster/weathermasterwindows/weathermaster-vertical (4).webp",
                },
                {
                  src: "/img/weathermaster/weathermasterwindows/weathermaster-vertical (5).webp",
                },
                {
                  src: "/img/weathermaster/weathermasterwindows/weathermaster-vertical (6).webp",
                },
                {
                  src: "/img/weathermaster/weathermasterwindows/weathermaster-vertical (7).webp",
                },
                {
                  src: "/img/weathermaster/weathermasterwindows/weathermaster-vertical (8).webp",
                },
                {
                  src: "/img/weathermaster/weathermasterwindows/weathermaster-vertical (9).webp",
                },
                {
                  src: "/img/weathermaster/weathermasterwindows/weathermaster-vertical (10).webp",
                },
                {
                  src: "/img/weathermaster/weathermasterwindows/weathermaster-vertical (11).webp",
                },
                {
                  src: "/img/weathermaster/weathermasterwindows/weathermaster-vertical (12).webp",
                },
                {
                  src: "/img/weathermaster/weathermasterwindows/weathermaster-vertical (13).webp",
                },
                {
                  src: "/img/weathermaster/weathermasterwindows/weathermaster-vertical (14).webp",
                },
                {
                  src: "/img/weathermaster/weathermasterwindows/weathermaster-vertical (15).webp",
                },
              ]}
              large={[
                {
