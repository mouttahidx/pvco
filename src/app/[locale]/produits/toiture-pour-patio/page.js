...
export async function generateMetadata() {
  const t = await getTranslations("PatioPage");
...
export default function Patios() {
  const t = useTranslations("PatioPage");
  const p = useTranslations("PatioModels");
  const models_images = [
    "/img/patio/sunspace-solid-patio-cover-banner-2.jpg",
    "/img/patio/sunspace-acrylic-patio-cover-banner-2.jpg",
    "/img/patio/sunspace-hybrid-patio-cover-banner-2.jpg",
  ];
  return (
    <>
      {/* hero  */}
      <section
        ...
        style={{ backgroundImage: "url('/img/patio/sunspace-acrylic-patio-cover-banner-2.jpg')" }}
      >
