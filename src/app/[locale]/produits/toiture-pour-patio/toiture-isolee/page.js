          ...
          <div className="mt-8">  
            <GalleryProductPage
              slides={[
                ...
                {src: "/img/patio/solid/patio-solid (3).webp"},
                {src: "/img/patio/solid/patio-solid (4).webp"},
                {src: "/img/patio/solid/patio-solid (5).webp"},
                {src: "/img/patio/solid/patio-solid (6).webp"},
                {src: "/img/patio/solid/patio-solid (7).webp"},
                {src: "/img/patio/solid/patio-solid (8).webp"},
                {src: "/img/patio/solid/patio-solid (9).webp"},
                {src: "/img/patio/solid/patio-solid (10).webp"},
                {src: "/img/patio/solid/patio-solid (11).webp"},
                {src: "/img/patio/solid/patio-solid (12).webp"},
                {src: "/img/patio/solid/patio-solid (13).webp"},
                {src: "/img/patio/solid/patio-solid (14).webp"},
                {src: "/img/patio/solid/patio-solid (15).webp"},
