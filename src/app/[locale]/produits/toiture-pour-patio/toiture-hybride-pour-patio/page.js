...
export async function generateMetadata() {
  const t = await getTranslations("PatioModelHybrid");
...
export default function PatioModelHybrid() {
  const t = useTranslations("PatioModelHybrid");
  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          backgroundImage:
            "url('/img/patio/hybrid/sunspace-hybrid-patio-cover-banner-3.jpg')",
        }}
      >
      ...
      <section className="max-w-7xl mx-auto pt-32 pb-16 grid grid-cols-1 lg:grid-cols-3 gap-x-8">
        ...
        <div className="lg:col-span-2 px-2">
          <Image
            alt={t("title")}
            src={"/img/patio/hybrid/sunspace-hybrid-patio-cover-banner-4.jpg"}
            width={1200}
            height={720}
        ...
        <div className="w-full lg:col-span-3 mt-14 px-2">
          ...
          <div className="mt-8">
            <GalleryProductPage
              slides={[
                { src: "/img/patio/hybrid/patio-hybrid (1).webp" },
                { src: "/img/patio/hybrid/patio-hybrid (2).webp" },
                { src: "/img/patio/hybrid/patio-hybrid (3).webp" },
                { src: "/img/patio/hybrid/patio-hybrid (4).webp" },
                { src: "/img/patio/hybrid/patio-hybrid (5).webp" },
                { src: "/img/patio/hybrid/patio-hybrid (6).webp" },
                { src: "/img/patio/hybrid/patio-hybrid (7).webp" },
                { src: "/img/patio/hybrid/patio-hybrid (8).webp" },
                { src: "/img/patio/hybrid/patio-hybrid (9).webp" },
                { src: "/img/patio/hybrid/patio-hybrid (10).webp" },
                { src: "/img/patio/hybrid/patio-hybrid (11).webp" },
                { src: "/img/patio/hybrid/patio-hybrid (12).webp" },
                { src: "/img/patio/hybrid/patio-hybrid (13).webp" },
                { src: "/img/patio/hybrid/patio-hybrid (14).webp" },
                { src: "/img/patio/hybrid/patio-hybrid (15).webp" },
                { src: "/img/patio/hybrid/patio-hybrid (16).webp" },
                { src: "/img/patio/hybrid/patio-hybrid (17).webp" },
                { src: "/img/patio/hybrid/patio-hybrid (18).webp" },
              ]}
              large={[
                { src: "/img/patio/hybrid/patio-hybrid (1).webp" },
                { src: "/img/patio/hybrid/patio-hybrid (2).webp" },
