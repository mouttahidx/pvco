...
export default function page({ locale }) {
  ...
  return (
    <>
      ...
      {/* about2 section */}
      <section
        className="py-8 xl:py-16 px-1 max-w-6xl mx-auto grid gap-x-16 md:grid-cols-2 items-center"
        data-aos="fade-in"
        data-aos-delay="300"
        data-aos-duration="1000"
      >
        ...
        <div className="grid grid-cols-2 gap-6 max-w-lg mx-auto my-12">
          <div className="flex flex-col gap-4 items-center">
            <div className="bg-secondary p-5 rounded-full w-fit">
              <img src="/worker.svg" className="w-48 h-48" />
            </div>
            <h3 className="text-3xl  text-center">Éric Choinière</h3>
          </div>
          <div className="flex flex-col gap-4 items-center">
            <div className="bg-secondary p-5 rounded-full w-fit">
              <img src="/worker.svg" className="w-48 h-48" />
            </div>
            <h3 className="text-3xl  text-center">Michel Choinière</h3>
          </div>
        </div>
        <ButtonClient
