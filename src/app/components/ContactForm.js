...
export default function ContactForm({ translations,theme = "light" }) {
  ...
  async function sendEmail(data) {
    ...
    formData.append('cv',cvRef.current)
    const res = await axios.post("/api/free-quote", formData ,{headers:{
